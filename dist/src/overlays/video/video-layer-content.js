...
const VideoLayerContent = ({ overlay, baseUrl, }) => {
    ...
    return (react_1.default.createElement("div", { style: containerStyle },
        react_1.default.createElement(remotion_1.Video, { muted: true, src: videoSrc, startFrom: overlay.videoStartTime || 0, style: videoStyle, volume: (_e = overlay.styles.volume) !== null && _e !== void 0 ? _e : 1, playbackRate: (_f = overlay.speed) !== null && _f !== void 0 ? _f : 1 })));
};
