...
exports.getPresetById = exports.parseFilterString = exports.MEDIA_FILTER_PRESETS = void 0;
exports.MEDIA_FILTER_PRESETS = [
    {
        id: "none",
        name: "None",
    ...
    },
    {
        id: "wesAnderson",
        name: "Wes Anderson",
        description: "Bold symmetrical aesthetics with highly saturated pastel tones",
    ...
    },
    {
        ...
        filter: "contrast(110%) brightness(100%) saturate(85%) sepia(20%) hue-rotate(5deg)",
    },
    {
        id: "kodak",
        name: "Kodak",
        description: "Classic film stock with rich colors and golden highlights",
        filter: "contrast(120%) brightness(105%) saturate(120%) sepia(10%) hue-rotate(355deg)",
    },
    {
        id: "super8",
        name: "Super 8",
        description: "Grainy retro film effect with warm nostalgic tone",
        filter: "contrast(125%) brightness(95%) saturate(70%) sepia(30%) hue-rotate(340deg)",
    },
];
/**
 ...
 */
const parseFilterString = (filterString = "none") => {
...
const getPresetById = (presetId) => {
    return (exports.MEDIA_FILTER_PRESETS.find((preset) => preset.id === presetId) ||
        exports.MEDIA_FILTER_PRESETS[0]); // Default to "none" preset
};
